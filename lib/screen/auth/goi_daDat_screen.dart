...
class _GoiDaDatScreenState extends State<GoiDaDatScreen> {
  List<ModelLocal2> listFilter = [
    ModelLocal2(name: 'Kiểm soát dầu, thu gọn lỗ chân lông', id: '200.000',value: true),
    ModelLocal2(
        name:
                        ...
                        ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            return Column(
                              children: [
                                Container(
                                  width: Const.size(context).width * 0.9,decoration: BoxDecoration(
                                  ...
                                  child: Padding(
                                    ...
                                    child: Column(crossAxisAlignment: CrossAxisAlignment.start,
                                     ...
                                     Container(
                                       ...
                                       child: Text('Combo Chăm Sóc Da Mặt + Gội Đầu Thảo Dược',style: StyleApp.textStyle600(color: ColorApp.dark,fontSize: 16),),
                                     ),
                                        SizedBox(height: 7,),
                                        Text('₫ ${Const.ConvertPrice.format(1200000)}',style: StyleApp.textStyle700(color: ColorApp.bottomBar,fontSize: 16),),
                                          ...
                                          children: [
                                            Row(
                                              children: [
                                                ...
                                                Text('   6 buổi', style: StyleApp.textStyle500(color: ColorApp.darkGreen),),
                                                SizedBox(width:Const.size(context).width *0.03846153846 ,),
                                                Text('Còn lại: 3 buổi', style: StyleApp.textStyle500(color: ColorApp.darkGreen),)
                                              ],
                                            ),
                                            InkWell(
                                              ...
                                              child: Container(
                                                alignment: Alignment.center,
                                                decoration: BoxDecoration(
                                                    color:index%2==1? ColorApp.bottomBar:ColorApp.orange,
                                                    borderRadius:
                                                    BorderRadius.circular(
                                                        12)),
                                                child: Padding(
                                                  padding: EdgeInsets.symmetric(
                                                      ...
                                                      Const.size(context)
                                                          ...
                                                          0.04615384615),
                                                  child: Text(
                                                    '${index%2==1?language.datLich:language.datThem}',
                                                    style:
                                                    StyleApp.textStyle700(
                                                        color:
                                                        Colors.white),
