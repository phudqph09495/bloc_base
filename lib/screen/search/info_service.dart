              ...
              child: Row(
                children: [
                  Expanded(
                    ...
                    text: lang.muaGoi,
                    function: () {
                      _burchaseBuyBottomSheet(context, lang);
                    },
                  )),
                  const SizedBox(
                    width: 10,
...
''',
  ...
  Future<dynamic> _serviceBottomSheet(BuildContext context, Language lang) {
                    ...
                    children: [
                      ...
                      DropdownButtonFormField2(
                        ...
                        buttonStyleData: ButtonStyleData(
                          height: Const.size(context).width * 0.1282051282,
                          padding: EdgeInsets.only(
                              left: Const.size(context).width * 0.02846153846,
                              right: Const.size(context).width * 0.01846153846),
                        ),
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          InkWell(
                            onTap: () {
                              _addedToCartBottomSheet(context, lang);
                            },
                            child: Container(
  ...
  Future<dynamic> _burchaseBuyBottomSheet(BuildContext context, Language lang) {
    return showModalBottomSheet(
        context: context,
        builder: (BuildContext context) {
          return StatefulBuilder(
...
class _DescribleServiceWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Container(
        alignment: Alignment.center,
        decoration: const BoxDecoration(gradient: ColorApp.linearGradientMain),
        width: double.infinity,
        child: Padding(
          ...
          child: Row(
            ...
            children: [
              Text(
                text,
                style: StyleApp.textStyle400(color: ColorApp.bottomBar),
                textAlign: TextAlign.center,
              ),
              Icon(
                icon,
