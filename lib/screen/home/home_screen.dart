...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(drawer: ItemDrawer(),
      key: _scaffoldKey,
      body: BlocBuilder<BlocLang,StateBloc>(builder: ( context,StateBloc state) {
                    ...
                    children: [
                      ...
                      ImageSlideshow(
                        children: List.generate(3,
                                (index) => Image.asset('assets/images/bannerHome.png')),
                        // [
                                  ...
                                  child: Padding(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        Container(
                                          width:
                                          Const.size(context).width * 0.688888,
                                          decoration: BoxDecoration(
                                              color: ColorApp.pink,
                                              borderRadius:
                                        ...
                                        Padding(
                                          ...
                                          child: Text(
                                            'Nhận Ngay',
                                            style: StyleApp.textStyle700(
                                                color: ColorApp.pink, fontSize: 13),
                                          ),
                                        ),
                                      ],
                                    ),
                                          ...
                                          Container(
                                            ...
                                            child: Text(
                                              ...
                                              style: SafeGoogleFont(
                                                ...
                                                fontWeight: FontWeight.w700,
                                                height: 1.2575 * ffem / fem,
                                                letterSpacing: 0.0120000001 * fem,
                                                color: Color(0xff252525),
                                              ),
                                            ),
                                          ),
